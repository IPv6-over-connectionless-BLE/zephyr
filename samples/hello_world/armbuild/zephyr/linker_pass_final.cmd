...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x80000 + 0), LENGTH = (512*1K - 0)
    SRAM (wx) : ORIGIN = 0x20070000, LENGTH = (96 * 1K)
    IDT_LIST (wx) : ORIGIN = (0x20070000 + (96 * 1K)), LENGTH = 2K
    }
SECTIONS
    {
   
 _image_rom_start = (0x80000 + 0);
    text :
 {
 . = 0x0;
 _vector_start = .;
 ...
 *(".kernel.*")
  ...
  *(".net_l2.data")
  ...
  __net_l2_data_end = .;
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x20070000 + (96 * 1K);
