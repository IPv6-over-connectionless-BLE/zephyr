...
/* PDU Sizes */
#define PDU_AC_PAYLOAD_SIZE_MAX    255
#define PDU_AC_SIZE_MAX (offsetof(struct pdu_adv, payload) + \
			 PDU_AC_PAYLOAD_SIZE_MAX)
#define PDU_EM_SIZE_MAX offsetof(struct pdu_data, lldata)


#define adv_addr_flag 	BIT(0)
#define tgt_addr_flag   BIT(1)
#define rfu0_flag     	BIT(2)
#define adi_flag      	BIT(3)
#define aux_ptr_flag  	BIT(4)
#define sync_info_flag 	BIT(5)
#define tx_pwr_flag 	BIT(6)
#define rfu1_flag 		BIT(7)
